...
import expensemanager.feature.filter4mp.generated.resources.accounts
...
private fun FilterSelectionView(
    ...
    Column(modifier = modifier) {
        Text(
            ...
            text = stringResource(resource = Res.string.transaction_type),
        ...
        Text(
            ...
            text = stringResource(resource = Res.string.accounts),
            style = MaterialTheme.typography.titleMedium,
            fontWeight = FontWeight.Black,
        )
        Row(modifier = Modifier.fillMaxWidth()) {
        ...
        Box(
            ...
            TextButton(
                ...
                Text(text = stringResource(resource = Res.string.apply))
            }
        }
    }
}
