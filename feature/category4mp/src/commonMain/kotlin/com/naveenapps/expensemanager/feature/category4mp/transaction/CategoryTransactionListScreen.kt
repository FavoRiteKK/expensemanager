...
import com.naveenapps.expensemanager.core.common4mp.utils.UiState
...
import com.naveenapps.expensemanager.core.designsystem4mp.ui.components.SmallIconAndBackgroundView
...
import com.naveenapps.expensemanager.core.model4mp.PieChartData
        ...
        UiState.Empty -> {
            Box(modifier = Modifier.fillMaxWidth()) {
                Text(
                    ...
                    text = stringResource(Res.string.no_transactions_available),
                ...
                if (state.data.categoryTransactions.isEmpty()) {
                    item {
                        EmptyItem(
                            ...
                            emptyItemText = stringResource(Res.string.no_transactions_available),
                            icon = "ic_no_grouping_available"
                        )
                    }
                } else {
                    items(
