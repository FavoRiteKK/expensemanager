...
import expensemanager.feature.theme4mp.generated.resources.Res
import expensemanager.feature.theme4mp.generated.resources.choose_theme
                ...
                item {
                    Text(
                        modifier = Modifier
                            .fillMaxWidth()
                            .padding(16.dp),
                        text = stringResource(resource = Res.string.choose_theme),
                        fontSize = 20.sp,
                ...
                items(themes, key = { it.mode }) { theme ->
                    ...
                    Row(
                        ...
                        Text(
                            ...
                            text = stringResource(resource = theme.titleResId),
                        )
                        if (isThemeSelected) {
                            Icon(
