...
import expensemanager.feature.country4mp.generated.resources.Res
import expensemanager.feature.country4mp.generated.resources.clear_search_text
import expensemanager.feature.country4mp.generated.resources.search_country
            ...
            OutlinedTextField(
                ...
                label = {
                    Text(
                        ...
                        text = stringResource(
                            resource = Res.string.search_country
                        ),
                ...
                trailingIcon = {
                    if (state.showClearButton) {
                        Icon(
                            ...
                            contentDescription = stringResource(Res.string.clear_search_text)
                        )
                    }
                }
            )
