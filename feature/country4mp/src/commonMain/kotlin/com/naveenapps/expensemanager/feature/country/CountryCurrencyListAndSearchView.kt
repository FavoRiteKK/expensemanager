...
import expensemanager.feature.country4mp.generated.resources.currency_description
    ...
    LazyColumn(modifier = modifier) {
        items(countries) {
            CountryWithCurrencyItemView(
                name = it.name,
                description = it.getCurrencyName(),
                modifier = Modifier
                    .clickable {
                        selection?.invoke(it)
                    }
...
@Composable
fun Country.getCurrencyName(): String {
    ...
    return stringResource(Res.string.currency_description, currencyName, currencySymbol)
}