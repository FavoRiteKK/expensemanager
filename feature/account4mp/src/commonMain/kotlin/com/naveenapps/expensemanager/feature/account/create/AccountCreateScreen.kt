...
import expensemanager.feature.account4mp.generated.resources.account_name
import expensemanager.feature.account4mp.generated.resources.account_name_error
import expensemanager.feature.account4mp.generated.resources.accounts
import expensemanager.feature.account4mp.generated.resources.available_balance
import expensemanager.feature.account4mp.generated.resources.credit_limit
import expensemanager.feature.account4mp.generated.resources.credit_limit_error
import expensemanager.feature.account4mp.generated.resources.current_balance
import expensemanager.feature.account4mp.generated.resources.current_balance_error
    ...
    Scaffold(
        ...
        topBar = {
            TopNavigationBarWithDeleteAction(
                title = stringResource(resource = Res.string.accounts),
        ...
        if (totalAmount.isNotBlank()) {
            Row(
                modifier = Modifier
                    .padding(start = 16.dp, end = 16.dp, top = 16.dp)
                    .background(
                        color = Color(color = totalAmountBackgroundColor).copy(.1f),
                ...
                Text(
                    ...
                    text = stringResource(resource = Res.string.available_balance),
...
private fun AccountCreateStatePreview() {
    ...
    val selectedColorField = TextFieldValue(
        value = "#FF000000", valueError = false, onValueChange = { }
    )
