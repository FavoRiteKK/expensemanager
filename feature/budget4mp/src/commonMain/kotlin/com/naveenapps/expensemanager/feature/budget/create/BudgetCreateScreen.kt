...
import expensemanager.feature.budget4mp.generated.resources.all
import expensemanager.feature.budget4mp.generated.resources.budget_amount
import expensemanager.feature.budget4mp.generated.resources.budget_amount_error
import expensemanager.feature.budget4mp.generated.resources.budget_name
import expensemanager.feature.budget4mp.generated.resources.budget_name_error
    ...
    Scaffold(
        ...
        topBar = {
            TopNavigationBarWithDeleteAction(
                title = stringResource(resource = Res.string.budgets),
...
fun BudgetCreateScreen(
    ...
    selectedDate: TextFieldValue<LocalDateTime>,
    accountCount: String,
    ...
    if (showDatePicker) {
        MonthPicker(
            ...
            confirmButtonCLicked = { month, year ->
                LocalDateTime(year, month, 1, 0, 0).let {
                    selectedDate.onValueChange?.invoke(it)
                }
    ...
    Column(modifier = modifier) {
        ...
        StringTextField(
            ...
            errorMessage = stringResource(resource = Res.string.budget_name_error),
            onValueChange = nameField.onValueChange,
            label = Res.string.budget_name,
        )
        ...
        DecimalTextField(
            ...
            errorMessage = stringResource(resource = Res.string.budget_amount_error),
            onValueChange = amountField.onValueChange,
            leadingIconText = currencyIconField,
            label = Res.string.budget_amount,
        )
