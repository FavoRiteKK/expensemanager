...
import expensemanager.feature.export4mp.generated.resources.all
import expensemanager.feature.export4mp.generated.resources.export_error_message
import expensemanager.feature.export4mp.generated.resources.export_success_message
import expensemanager.feature.export4mp.generated.resources.today
...
class ExportViewModel (
    ...
    private val _state = MutableStateFlow(
        ExportState(
            ...
            selectedDateRangeText = UiText.ResString(Res.string.today),
            fileType = ExportFileType.CSV,
            accountCount = UiText.ResString(Res.string.all),
            ...
            _state.update {
                it.copy(
                    ...
                    selectedDateRangeText = if (dateRange.description.isBlank()) {
                        UiText.ResString(Res.string.all)
                    } else {
        ...
        viewModelScope.launch {
            ...
            when (response) {
                is Resource.Error -> {
                    _event.send(
                        ExportEvent.Error(
                            UiText.ResString(Res.string.export_error_message)
                        )
                    )
                }
                ...
                is Resource.Success -> {
                    _event.send(
                        ExportEvent.FileExported(
                            message = UiText.ResString(Res.string.export_success_message),
