...
import com.naveenapps.expensemanager.core.common4mp.utils.getThisMonthRange
import com.naveenapps.expensemanager.core.common4mp.utils.getThisWeekRange
import com.naveenapps.expensemanager.core.common4mp.utils.getThisYearRange
import com.naveenapps.expensemanager.core.common4mp.utils.getTodayRange
import com.naveenapps.expensemanager.core.common4mp.utils.toCompleteDate
import com.naveenapps.expensemanager.core.common4mp.utils.toDate
import com.naveenapps.expensemanager.core.common4mp.utils.toDateAndMonth
import com.naveenapps.expensemanager.core.common4mp.utils.toEpochMilliseconds
import com.naveenapps.expensemanager.core.common4mp.utils.toMonthAndYear
import com.naveenapps.expensemanager.core.common4mp.utils.toYear
...
class DateRangeFilterRepositoryImpl(
    ...
    override suspend fun setDateRanges(dateRanges: List<LocalDateTime>): Resource<Boolean> =
        withContext(dispatcher.io) {
            dataStore.setDateRanges(
                dateRanges[0].toEpochMilliseconds(TimeZone.currentSystemDefault()),
                dateRanges[1].toEpochMilliseconds(TimeZone.currentSystemDefault())
            )
            return@withContext Resource.Success(true)
        }
    ...
    private fun getFormattedDateRangeString(
        ...
        val fromDateTime =
            fromDate.toInstant(TimeZone.currentSystemDefault()).toLocalDateTime(TimeZone.UTC)
        val toDateTime =
