...
import com.naveenapps.expensemanager.core.common4mp.utils.toMonth
import com.naveenapps.expensemanager.core.common4mp.utils.toYearInt
...
fun MonthPickerPreview() {
    ExpenseManagerTheme {
        MonthPicker(
            ...
            currentMonth = Clock.System.now().asCurrentDateTime().toMonth(),
            currentYear = Clock.System.now().asCurrentDateTime().toYearInt(),
